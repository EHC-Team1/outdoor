...
<div class="container">
      ...
      <table class="table table-borderless">
        <tbody>
          ...
          foreach ($deliveries as $delivery) {
            $i++ ?>
            <tr>
              <th scope="row" class="col-sm-1 align-middle h6">
                <?= $i ?>. <?= $delivery['name'] ?> 様
              </th>
            </tr>
            <tr class="border-bottom">
              <td class="col-sm-8 align-middle pb-3">
                <?= '〒' . substr_replace($delivery['postal_code'], '-', 3, 0) ?><br>
                <div class="col-auto">
                  <?= $delivery['address'] . $delivery['house_num'] ?>
                </div>
              </td>
              <td class="col-sm-2 align-middle pb-3">
  ...
  <form action="delivery_input.php" method="POST" class="text-center">
    <input type="submit" name="" class="btn btn-outline-primary btn-lg mb-5" value="配送先追加">
  </form>
</div>
